...
module GData
  ...
  class Service
    ...
    def request(method, uri_string, data=nil, limit = 5)
    ...
    def get_data(uri_string, limit = 5)
    	request("GET", uri_string, nil, limit)
    end

    def delete_data(uri_string, limit = 5)
    	request("DELETE", uri_string, nil, limit)
    end

    def post_data(uri_string, data, limit = 5)
    	request("POST", uri_string, data, limit)
    end

    def put_data(uri_string, data, limit = 5)
    	request("PUT", uri_string, data, limit)
    end
